...
float leftETA = 0;
float rghtETA = 0;
int leftImpactWarn = 0;
int rghtImpactWarn = 0;
...
{
  switch(leftImpactWarn)
  {
    case 1:
      Serial.print("!!WARNING!! -- !!LEFT!! -- !!IMPACT PROBABLE!!");
      break;
    case 2:
  ...
  switch(rghtImpactWarn)
  {
    case 1:
      Serial.print("\t\t!!WARNING!! -- !!RIGHT!! -- !!IMPACT PROBABLE!!");
      Serial.println("");
      break;
    case 2:
...
{
  leftETA = newLeftDist / leftVelEst;
   
  if (leftETA < 500.00 && leftETA > 0.00)//Will likely impact user before they can react
  {
    leftImpactWarn = 1;
  }
...
{
  rghtETA = newRghtDist / rghtVelEst;
   
  if (rghtETA < 500.00 && rghtETA > 0.00)//Will likely impact user before they can react
  {
    rghtImpactWarn = 1;
  }
